<template>
  <div class="about-setting card p-2 m-2">
    <div class="flex flex-col items-center justify-center py-4">
      ...
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">文声AI</h1>
      <p class="text-gray-500 dark:text-gray-400 mb-6">VwordAI v1.0.0</p>
      ...
      <div class="max-w-md w-full mb-6">
        <p class="text-center text-gray-600 dark:text-gray-300">
          VwordAI
          是一款智能文本转语音工具，支持多种语音服务提供商，让您轻松将文本转为自然流畅的语音。
        </p>
      </div>
...
const openGithub = () => {
  window.open("https://github.com/vwordai", "_blank");
};
</script>
