...
export const projectApi = {
  ...
  update: (id: string, data: any) =>
    invoke<Result<any>>("update-project", id, data),
  ...
  getByIdViaHandler: (id: string) =>
    invokeHandler<Result<any>>("getProject", id),
  ...
  createViaHandler: (data: any) =>
    invokeHandler<Result<any>>("createProject", data),
  ...
  updateViaHandler: (id: string, data: any) =>
    invokeHandler<Result<any>>("updateProject", id, data),
  ...
  deleteViaHandler: (id: string) =>
    invokeHandler<Result<any>>("deleteProject", id),
};
...
export const chapterApi = {
  ...
  getByProjectId: (projectId: string) =>
    invoke<Result<any>>("get-chapters-by-project-id", projectId),
   ...
   */
  update: (id: string, data: any) =>
    invoke<Result<any>>("update-chapter", id, data),
  ...
  getByProjectIdViaHandler: (projectId: string) =>
    invokeHandler<Result<any>>("getChaptersByProjectId", projectId),
   ...
   */
  getByIdViaHandler: (id: string) =>
    invokeHandler<Result<any>>("getChapter", id),
   ...
   */
  createViaHandler: (data: any) =>
    invokeHandler<Result<any>>("createChapter", data),
   ...
   */
  updateViaHandler: (id: string, data: any) =>
    invokeHandler<Result<any>>("updateChapter", id, data),
   ...
   */
  deleteViaHandler: (id: string) =>
    invokeHandler<Result<any>>("deleteChapter", id),
};
...
export const ttsApi = {
  ...
  synthesize: (chapterId: string) =>
    invoke<Result<any>>("tts:synthesize", chapterId),
  ...
  synthesizeMultiple: (chapterIds: string[]) =>
    invoke<Result<any>>("tts:synthesize-multiple", chapterIds),
  ...
  getEmotions: (providerId: string) =>
    invoke<Result<any>>("tts:get-emotions", providerId),
  ...
  testProviderConnection: (providerType: string) =>
    invoke<Result<any>>("tts:test-provider-connection", providerType),
  ...
  synthesizeViaHandler: (chapterId: string) =>
    invokeHandler<Result<any>>("synthesizeChapter", chapterId),
  ...
  synthesizeMultipleViaHandler: (chapterIds: string[]) =>
    invokeHandler<Result<any>>("synthesizeMultipleChapters", chapterIds),
};
...
export const serviceProviderApi = {
  ...
  testConnection: (id: string) =>
    invoke<Result<any>>("service-provider:test-connection", id),
   ...
   */
  deleteViaHandler: (id: string) =>
    invokeHandler<Result<any>>("deleteServiceProvider", id),
  ...
  testConnectionViaHandler: (id: string) =>
    invokeHandler<Result<any>>("testServiceProviderConnection", id),
};
...
export const settingsApi = {
  ...
  setDefaultExportPath: (path: string) =>
    invoke<Result<any>>("set-default-export-path", path),
   ...
   * @param data 服务商配置数据
   */
  updateProviderSettings: (provider: string, data: any) =>
   ...
   * @param type 服务商类型
   */
  testProviderConnection: (type: string) =>
    invoke<Result<any>>("test-provider-connection", type),
   ...
   * @param data 设置数据
   */
  updateViaHandler: (data: any) =>
    invokeHandler<Result<any>>("updateSettings", data),
